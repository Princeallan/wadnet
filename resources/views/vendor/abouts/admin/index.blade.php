...
@section('title', __('Abouts'))

@section('content')

<div ng-cloak ng-controller="ListController">

    @include('core::admin._button-create', ['module' => 'abouts'])
    ...
    <div class="table-responsive">
        ...
        <table st-persist="aboutsTable" st-table="displayedModels" st-safe-src="models" st-order st-filter class="table table-main">
            <thead>
                <tr>
                    <th class="delete"></th>
                    <th class="edit"></th>
            ...
            <tbody>
                <tr ng-repeat="model in displayedModels">
                    ...
                    <td>
                        @include('core::admin._button-edit', ['module' => 'abouts'])
                    </td>
