...
<div ng-cloak ng-controller="ListController">
    ...
    @include('core::admin._button-create', ['module' => 'magazines'])

    <h1>@lang('Magazines')</h1>
    ...
    <div class="table-responsive">
        ...
        <table st-persist="magazinesTable" st-table="displayedModels" st-safe-src="models" st-order st-filter class="table table-main">
            <thead>
                <tr>
                    <th class="delete"></th>
                    <th class="edit"></th>
            ...
            <tbody>
                <tr ng-repeat="model in displayedModels">
                    ...
                    <td>
                        @include('core::admin._button-edit', ['module' => 'magazines'])
                    </td>
